...
- Finalized the release-facing preset names as Momento, Wired, and Arcade, with automatic migration from the earlier Momento Cutout, Cyberia, and interim terminal-style identifiers and palettes.
...
- Added independent two-line bilingual and three-line single-language clamps to Clean, Classic Outline, Yellow Drop, Arcade, Momento, and Wired.
