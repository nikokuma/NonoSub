  ...
  <main>
    ...
    <aside class="right-rail">
      ...
      <section class="tutor">
        ...
        {/if}
        <div class="chat">
          {#each tutorMessages.slice(-3) as message}<div class:assistant={message.role === "assistant"} class="message">{message.text}</div>{/each}
        </div>
...
<style>
  ...
  .right-rail{min-height:0;display:grid;grid-template-rows:45px minmax(160px,.75fr) minmax(390px,1.25fr);background:rgba(14,13,25,.76)}.rail-tabs{display:flex;align-items:end;padding:0 14px;border-bottom:1px solid var(--line)}.rail-tabs button{height:44px;border:0;background:none;color:#777181;font-size:10px;padding:0 10px}.rail-tabs button.active{color:white;border-bottom:2px solid var(--pink)}.rail-tabs span{margin-left:auto;align-self:center;color:var(--mint);font-size:8px}
  ...
  .tutor{min-height:0;border-top:1px solid var(--line);display:flex;flex-direction:column;overflow:hidden}.tutor-title{padding:0 14px 8px;justify-content:space-between}.tutor-title strong{display:block;font-size:13px}.level{text-transform:uppercase;font-size:8px;background:rgba(155,140,255,.14);color:#b9adff;border:1px solid rgba(155,140,255,.25);border-radius:10px;padding:4px 7px}.selected-line{margin:0 14px;padding:9px 10px;border-radius:9px;background:rgba(255,255,255,.045);display:grid;gap:3px}.selected-line span{font-size:8px;text-transform:uppercase;font-weight:bold}.selected-line b{font-size:11px}.selected-line small{font-size:9px;color:#8e8898}.quick-prompts{display:flex;gap:5px;padding:8px 14px;overflow-x:auto}.quick-prompts button{white-space:nowrap;border:1px solid var(--line);border-radius:14px;background:#242035;padding:5px 8px;font-size:8px}.chat{padding:0 14px;overflow-y:auto;display:grid;gap:6px}.message{margin-left:18%;background:#2b263d;border-radius:9px;padding:8px;font-size:9px;line-height:1.4}.message.assistant{margin:0 18% 0 0;background:rgba(255,114,182,.09);border:1px solid rgba(255,114,182,.12)}.tutor form{margin:8px 14px 0;display:grid;grid-template-columns:1fr 30px;border:1px solid var(--line);border-radius:9px;background:#181522}.tutor textarea{height:40px;resize:none;border:0;background:none;color:white;padding:8px;font-size:9px;outline:0}.tutor form button{margin:6px;width:25px;height:25px;border:0;border-radius:50%;background:var(--pink);color:#17101a}.context-note{text-align:center;color:#686271;font-size:7px;margin:5px 0 8px}
