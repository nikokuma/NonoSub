...
<style>
  ...
  .bubble{position:absolute;z-index:9;left:var(--bubble-x);top:var(--bubble-y);width:var(--bubble-width);height:var(--bubble-height);display:flex;align-items:center;padding:clamp(6px,calc(18px * var(--stage-scale)),18px);padding-right:clamp(25px,calc(42px * var(--stage-scale)),42px);overflow:visible;background:#fff;color:#24232a;border:clamp(1px,calc(2px * var(--stage-scale)),2px) solid #4f3b46;border-radius:clamp(10px,calc(20px * var(--stage-scale)),20px) clamp(10px,calc(20px * var(--stage-scale)),20px) clamp(10px,calc(20px * var(--stage-scale)),20px) clamp(3px,calc(5px * var(--stage-scale)),5px);font-size:clamp(6px,calc(13px * var(--stage-scale)),13px);line-height:1.4;box-shadow:clamp(2px,calc(6px * var(--stage-scale)),6px) clamp(2px,calc(7px * var(--stage-scale)),7px) 0 #291e2355;transition:color .2s,transform .2s;box-sizing:border-box}
  .bubble::after{content:"";position:absolute;left:18%;bottom:calc(-9px * var(--stage-scale));width:clamp(8px,calc(17px * var(--stage-scale)),17px);height:clamp(8px,calc(17px * var(--stage-scale)),17px);background:#fff;border-right:clamp(1px,calc(2px * var(--stage-scale)),2px) solid #4f3b46;border-bottom:clamp(1px,calc(2px * var(--stage-scale)),2px) solid #4f3b46;transform:rotate(45deg);box-sizing:border-box}
